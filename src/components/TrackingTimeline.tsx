        ...
        <ol className="relative space-y-6 border-l border-border pl-6">
          {sortedEvents.map((e, idx) => (
            <li key={e.id} className="relative">
              <span className={`absolute -left-[31px] top-0.5 grid h-6 w-6 place-items-center rounded-full border-2 ${
                idx === 0 ? "border-pme-red bg-pme-red/10 text-pme-red" : "border-border bg-background text-muted-foreground"
              }`}>
